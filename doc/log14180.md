...
Er sollte auch mit einem PIKO IQ und PIKO CI funktionieren, NICHT aber mit PIKO MP oder PIKO 12-20. - Andere Kostal-Wechselrichter haben andere Modbus-Register bzw. Kommunikationsmöglichkeiten.
Bitte nutzt eine aktuelle Firmware des Wechselrichters, da ansonsten ggf. Modbus-Register fehlen. 
Ist kein KSEM eingebunden, so sind alle Verbrauchswerte nicht verfügbar.
